package com.unhurdle.spectrum
{
    ...
    public class Calendar extends SpectrumBase
    {
        ...
        {
            trace("displayedYear - updateDisplay");
            trace(displayedYear);
            trace("displayedMonth - updateDisplay");
        ...
        public function selectRange(start:Date,end:Date):void{   
            ...
            var selectedStart:String = start.getDate().toString();
            var selectedEnd:String =  end.getDate().toString();
            ...
            for each (var row:HTMLTableRowElement in calenderBody.children){
                for each(var c:HTMLTableCellElement in row.children){
                    ...
                    s.classList.remove(isSelectedClass);
                    s.classList.remove(isRangeClass);
                    if(s.classList.contains("is-selection-start")){
                        s.classList.remove("is-selection-start");
                    }
                    else if(s.classList.contains("is-selection-end")){
                        s.classList.remove("is-selection-end");
                    }
        ...
        override public function addedToParent():void{
            ...
            (element as HTMLElement).appendChild(body);
        ...
        private function setDates():void{
            if(table.children.length && calenderBody){
            ...
            for (var k:int = 0; k<6;k++,l--){
               ...
               for(var j:int = 0; j<7; j++,l++){
                    ...
                    if(days[k+l]){
                        if(days[k+l].getFullYear() == today.getFullYear() && days[k+l].getMonth() == today.getMonth() && days[k+l].getDate() == today.getDate()){
