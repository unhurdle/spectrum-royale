    ...
    public function SplitView()
    {
      ...
      typeNames = "spectrum-SplitView";
        ...
        override protected function createElement():WrappedHTMLElement{
          ...
          left.className = "spectrum-SplitView-pane";
          elem.appendChild(left);
          splitter = newElement('div') as HTMLDivElement;
          splitter.className = "spectrum-SplitView-splitter";
          if(_isDraggable){
                splitter.appendChild(newElement("div","spectrum-SplitView-gripper"));
          }
          elem.appendChild(splitter);
          right = newElement('div') as HTMLDivElement;
          right.className = "spectrum-SplitView-pane";
          ...
          if(value != _isCollapsed){
            switch (value){
                    ...
                    case "bottom":right.style.height = "0";
                              directionCollapsed = "start";
                        break;
                    case "Resizable": if(direction == "horizontal"){
