  ...
  public class Application extends org.apache.royale.core.Application
  {
    ...
    public function set colorstop(value:String):void
    {
      if(value != _colorstop){
        ...
        element.classList.toggle(newStop, true);
        element.classList.toggle(oldStop, false);
      	_colorstop = value;
      }
    }
    ...
    public function set appScale(value:String):void
    {
      if(value != _appScale){
        ...
        element.classList.toggle(newScale, true);
        element.classList.toggle(oldScale, false);
